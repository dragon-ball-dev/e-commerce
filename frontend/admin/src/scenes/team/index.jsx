...
const Product = () => {
  ...
  const columns = [
    ...
    { field: "price", headerName: "Price", type: "number", flex: 0.5, headerAlign: "center" },
    { field: "quantityStock", headerName: "Quantity Stock", type: "number", flex: 1, headerAlign: "center" },
    {
      field: "viewMore",
      headerName: "",
      flex: 0.5,
